...
@push('js')
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            // Nous n'avons pas de graphique totalVolumeChart dans le HTML, donc on le saute

            // Graphique 2 : Volume Exportation Mensuel (Histogramme)
            if (elementExists('monthlyExportChart')) {
            ...
            if (elementExists('topExportateursChart')) {
            ...
            if (elementExists('topEssencesChart')) {
            ...
            if (elementExists('topDestinationsChart')) {
            ...
            if (elementExists('conditionnementChart')) {
