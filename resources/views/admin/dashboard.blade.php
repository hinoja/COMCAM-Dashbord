                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalVolume'], 2, ',', ' ') }} m³</h3>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalTransactions'], 0, ',', ' ') }}</h3>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalTitres'], 0, ',', ' ') }}</h3>
                                                <small
                                                    class="text-muted">({{ number_format($stats['titresActifs'], 0, ',', ' ') }}
                                                    actifs cette année)</small>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalEssences'], 0, ',', ' ') }}</h3>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalSocietes'], 0, ',', ' ') }}</h3>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">
                                                    {{ number_format($stats['totalDestinations'], 0, ',', ' ') }}</h3>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="mt-2 mb-0">{{ number_format($stats['totalPays'], 0, ',', ' ') }}
                                                </h3>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseVolumeParMois" aria-expanded="true">
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseEvolutionAnnuelle" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseVolumeParForme" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseVolumeParConditionnement" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseTopDestinations" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseTopEssences" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow-sm h-100">
                                    <div
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool btn-sm" data-toggle="collapse"
                                                data-target="#collapseTopSocietes" aria-expanded="true">
                                                <i class="fas fa-minus text-white"></i>
                                            </button>
                                        </div>
                                    </div>
